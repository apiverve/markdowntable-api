...
const (
	baseURL        = "https://api.apiverve.com/v1/markdowntable"
	defaultTimeout = 30 * time.Second
)

// Client is the Markdown Table Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Markdown Table Generator API client.
...
// Execute makes a request to the Markdown Table Generator API with typed parameters.
//
