# Markdown Table Generator API - Examples

This folder contains example code for using the Markdown Table Generator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/markdowntable',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/markdowntable");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/markdowntable](https://docs.apiverve.com/ref/markdowntable)
