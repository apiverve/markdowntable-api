...
class TestMarkdowntableAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = MarkdowntableAPIClient(self.api_key)

    @patch('apiverve_markdowntablegenerator.apiClient.requests.get')
