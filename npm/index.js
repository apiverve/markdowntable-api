...
class markdowntableWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/markdowntable');
        }
        ...
        this.validationRules = {"headers":{"type":"array","required":true},"rows":{"type":"array","required":true},"alignment":{"type":"string","required":false,"default":"left"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/markdowntable`);
        }
    }
...
module.exports = markdowntableWrapper;
