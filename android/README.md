# Markdown Table Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:markdowntable-api:1.1.12'
}
```
...
```java
import com.apiverve.markdowntable.MarkdownTableGeneratorAPIClient;
import com.apiverve.markdowntable.APIResponse;
import com.apiverve.markdowntable.APIException;

// Initialize the client
MarkdownTableGeneratorAPIClient client = new MarkdownTableGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/markdowntable](https://docs.apiverve.com/ref/markdowntable)
...
- **Documentation:** [https://docs.apiverve.com/ref/markdowntable](https://docs.apiverve.com/ref/markdowntable)
- **Issues:** [GitHub Issues](https://github.com/apiverve/markdowntable-api/issues)
