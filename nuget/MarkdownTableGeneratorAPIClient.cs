...
namespace APIVerve.API.MarkdownTableGenerator
{
    ...
    /// <summary>
    /// Client for the MarkdownTableGenerator API
    /// </summary>
    public class MarkdownTableGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/markdowntable";
        ...
        {
            { "headers", new ValidationRule { Type = "array", Required = true } },
            { "rows", new ValidationRule { Type = "array", Required = true } },
            { "alignment", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public MarkdownTableGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdownTableGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdownTableGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MarkdownTableGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MarkdownTableGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(MarkdownTableGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MarkdownTableGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MarkdownTableGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MarkdownTableGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MarkdownTableGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MarkdownTableGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MarkdownTableGeneratorQueryOptions options)
        {
