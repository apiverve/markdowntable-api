...
namespace APIVerve\Markdowntable;
...
/**
 * Client for the Markdown Table Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/markdowntable?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/markdowntable';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MarkdowntableClient] {$message}\n";
        }
    }
}
